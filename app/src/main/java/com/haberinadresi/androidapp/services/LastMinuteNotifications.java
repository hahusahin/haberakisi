...
public class LastMinuteNotifications extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // if the last notification is at most 10 minutes old (to avoid showing notification over and over again)
        if(topic != null && System.currentTimeMillis() - lastNotificationTime > 600000L){
