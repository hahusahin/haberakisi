...
public class SliderAdapter extends PagerAdapter {
    ...
    private static final String SLIDE_DESC_6 = "Sağ üstteki arama ikonuna basarak istediğiniz yazar/kaynağa daha hızlı " +
            "ulaşabilirsiniz.";
    private static final String SLIDE_DESC_7 = "Ana menüden Ayarlar'a tıklayarak Gece modu, Mobil Veri Tasarrufu, " +
            "kategorileri düzenleme vb. ayarlara ulaşabilirsiniz.";
    private static final String SLIDE_DESC_8 = "Uygulama içerisinde karşılaştığınız sorunlardan dolayı olumsuz yorum yazmak yerine " +
    ...
    private int[] slide_images = {R.drawable.slide_1, R.drawable.slide_2, R.drawable.slide_3,
            R.drawable.slide_4, R.drawable.slide_5, R.drawable.slide_6, R.drawable.slide_7, R.drawable.slide_8};

    private String[] slide_descriptions = {SLIDE_DESC_1, SLIDE_DESC_2, SLIDE_DESC_3,
            SLIDE_DESC_4, SLIDE_DESC_5, SLIDE_DESC_6, SLIDE_DESC_7, SLIDE_DESC_8};
